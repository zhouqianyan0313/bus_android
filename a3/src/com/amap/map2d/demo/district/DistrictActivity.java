...
public class DistrictActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_ret = (Button) findViewById(R.id.city_return);
		_ret.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent _i = new Intent(DistrictActivity.this, RouteActivity.class);
				_i.putExtra("prov", prov);
				_i.putExtra("city", city);
				_i.putExtra("distr", distr);
				_i.putExtra("lat", lat);
				_i.putExtra("lng", lng);
				setResult(23, _i);
				finish();
