...
//				_b.putString("", value);
				Intent _i = new Intent(PoiKeywordSearchActivity.this, AtoZActivity.class);
	...
	protected void doSearchQuery() {
		...
		currentPage = 0;
		query = new PoiSearch.Query(keyWord, "公交车站|轻轨站|地铁站", editCity.getText().toString());// 第一个参数表示搜索字符串，第二个参数表示poi搜索类型，第三个参数表示poi搜索区域（空字符串代表全国）
